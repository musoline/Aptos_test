        ...
        <v-toolbar flat color="white">
          ...
          <v-dialog v-model="dialog">
            <template v-slot:activator="{ on }">
              <v-btn color="primary" dark class="mb-2" v-on="on">მომხმარებლის დამატება</v-btn>
            </template>
            <v-card>
              <v-card-title>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.surname" label="გვარი"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.email" label="ელ ფოსტა"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.account_type" label="ანგარიში"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.mobile" label="ნომერი"></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
              </v-card-text>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "გვარი", value: "surname", sortable: false },
      { text: "მეილი", value: "email", sortable: false },
      { text: "ანგარიში", value: "account_type", sortable: false },
